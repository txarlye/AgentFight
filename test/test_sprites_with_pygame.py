#!/usr/bin/env python3
"""
Script de prueba para verificar que los sprites de sample_character se cargan correctamente con Pygame inicializado.
"""
...
def test_sample_character_sprites_with_pygame():
    """Prueba que los sprites de sample_character se cargan correctamente con Pygame inicializado."""
    print("🎮 Probando carga de sprites de sample_character con Pygame...")
    ...
    try:
        ...
        # Crear una ventana temporal para poder cargar imágenes
        temp_screen = pg.display.set_mode((100, 100))
        pg.display.set_caption("Test Temporal")
        print("✅ Ventana temporal creada")
...
if __name__ == "__main__":
    print("🚀 Iniciando prueba de sprites de sample_character con Pygame...\n")
    
    success = test_sample_character_sprites_with_pygame()
